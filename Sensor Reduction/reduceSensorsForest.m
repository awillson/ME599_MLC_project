...
parfor i = 0:15
    ...
    ForestClassifier = TreeBagger(10,trainingDataCut,trainingLabels);
    
    accuracy1(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:14
    ...
    accuracy2(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:13
    ...
    accuracy3(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:12
    ...
    accuracy4(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:11
    ...
    accuracy5(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:10
    ...
    accuracy6(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:9
    ...
    accuracy7(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:8
    ...
    accuracy8(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:7
    ...
    accuracy9(i+1) = evaluateClassifier(ForestClassifier,testingDataCut)
end
...
parfor i = 0:6
    ...
    accuracy10(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:5
    ...
    accuracy11(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:4
    ...
    accuracy12(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:3
    ...
    accuracy13(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:2
    ...
    accuracy14(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
parfor i = 0:1
    ...
    accuracy15(i+1) = evaluateClassifier(ForestClassifier,testingDataCut);
end
...
sensorsOrderedForest = {'sensor7','sensor14','sensor9','sensor5',...
                        'sensor3','sensor15','sensor13','sensor16',...
                            'sensor11','sensor12','sensor2','sensor6',...
                                'sensor10','sensor4','sensor1','sensor8'};

%                             
sensorAccuracyPlotForest = fliplr(maxAcc);
% 
save('sensorReductionResultsForest.mat','sensorsOrderedForest','sensorAccuracyPlotForest')
